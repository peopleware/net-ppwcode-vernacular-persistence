...
namespace PPWCode.Vernacular.Persistence.III.Tests.IsSame
{
    ...
    public class Persistent_IsSame_Tests : BaseFixture
    {
        ...
        {
            PersistentFoo x = new PersistentFoo(1);
        ...
        {
            PersistentFoo x = new PersistentFoo(1);
            PersistentFoo y = new PersistentFoo(1);
        ...
        {
            PersistentFoo x = new PersistentFoo(1);
            PersistentSpecializedFoo y = new PersistentSpecializedFoo(1);
            Assert.That(x.IsSame(y), Is.True);
        }
        ...
        {
            PersistentFoo x = new PersistentFoo(1);
            PersistentFoo y = new PersistentFoo(2);
        ...
        {
            PersistentFoo x = new PersistentFoo();
            Assert.That(x.IsSame(x), Is.True);
        }
        ...
        {
            PersistentFoo x = new PersistentFoo();
            PersistentFoo y = new PersistentFoo();
            Assert.That(x.IsSame(y), Is.False);
        }
    }
}
