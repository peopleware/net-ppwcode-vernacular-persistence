...
{
    [Serializable]
    public class DefaultDirtyCheckEventListenerEx
        : DefaultDirtyCheckEventListener,
          IRegisterEventListener
    {
        private static readonly IInternalLogger s_Log = LoggerProvider.LoggerFor(typeof(DefaultDirtyCheckEventListenerEx));
        ...
        {
            cfg.EventListeners.DirtyCheckEventListeners = new IDirtyCheckEventListener[] { this };
        }
    }
}
