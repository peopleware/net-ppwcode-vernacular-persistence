...
{
    public class DefaultFlushEventListenerEx
        : DefaultFlushEventListener,
          IRegisterEventListener
    {
        private static readonly IInternalLogger s_Log = LoggerProvider.LoggerFor(typeof(DefaultFlushEventListenerEx));
        ...
        {
            cfg.EventListeners.FlushEventListeners = new IFlushEventListener[] { this };
        }
    }
}
