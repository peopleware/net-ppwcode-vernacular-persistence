...
namespace PPWCode.Vernacular.Persistence.I.Dao.NHibernate.Implementations
{
    public abstract class NhConfigurationBase : INhConfiguration
    {
        ...
        protected NhConfigurationBase(INhInterceptor nhInterceptor, INhProperties nhProperties, IMappingAssemblies mappingAssemblies, IRegisterEventListener[] registerEventListeners)
        {
