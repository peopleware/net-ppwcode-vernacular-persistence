...
namespace PPWCode.Vernacular.Persistence.I.Dao.NHibernate.Implementations
{
    ...
    {
        public NhConfiguration(INhInterceptor nhInterceptor, INhProperties nhProperties, IMappingAssemblies mappingAssemblies, IRegisterEventListener[] registerEventListeners)
            : base(nhInterceptor, nhProperties, mappingAssemblies, registerEventListeners)
        {
        }
