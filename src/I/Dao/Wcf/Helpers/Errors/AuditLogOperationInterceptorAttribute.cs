...
{
    public class AuditLogOperationInterceptorAttribute
        : OperationInterceptorBehaviorAttribute
    {
        private readonly AuditLevel m_AuditLevel;

        public AuditLogOperationInterceptorAttribute(AuditLevel auditLevel)
        {
        ...
        {
            return new AuditLogOperationInterceptor(oldInvoker, m_AuditLevel);
        }
    }
}
